...
<div>
        <main id="main-container">
                ...
                <div class="content ">
                        <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-alt">
                                ...
                                <li class="breadcrumb-item">Edit FAQ's-4</li>
                            </ol>
                        </nav>
                </div>
            ...
            <div class="content ">
                ...
                <form action="<?php echo base_url();?>faqs-setting-4" method="POST">
                    ...
                    <div class="block-content-full">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                            <button type="submit" style="float: right;" class="btn btn-info" id="update_faqs_4" name="update_faqs_4" onclick="getSummerNote();">Update</button>
                            </div>
                        </div>
                        <div class="row">
                            <div class="block-content block-content-full">
                                <div class="form-group">
                                    <textarea id="summernote" class="summernote" name="faqs_4"><?php echo $setting_faqs_4;?></textarea>
                                </div>
                            </div>   
                        </div>
