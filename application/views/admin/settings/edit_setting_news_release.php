...
<div>
    <main id="main-container">
        ...
        <div class="content ">
            ...
            <form action="<?php echo base_url();?>setting-news-release" method="POST">
                ...
                <div class="block-content-full">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <button type="submit" style="float: right;" class="btn btn-info" id="update_news_release"
                                name="update_news_release" onclick="getSummerNote();">Update</button>
                        </div>
                    </div>
                    <div class="row">
                        <div class="block-content block-content-full">
                            <div class="form-group">
                                <textarea id="summernote" class="summernote"
                                    name="news_release_description"><?php echo $news_release_description;?></textarea>
                            </div>
                        </div>
                    </div>
