<?php  $_SESSION['news_release_token']=md5(session_id() . time());?>
        ...
        <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-alt">
                ...
                <li class="breadcrumb-item"><a class="text-muted"
                        href="<?php echo base_url()?>news-release-settings">News Release</a></li>
                <li class="breadcrumb-item"><?php if($this->uri->segment(2)){?>Edit News Release<?php }else{?>Add
                    News Release<?php }?> </li>
            </ol>
        </nav>
    </div>
    ...
    <div class="content ">
        ...
        <div id="main_dialog_box" class="swal2-container swal2-center swal2-backdrop-show" style="overflow-y: auto;">
            <div aria-labelledby="swal2-title" aria-describedby="swal2-content"
                ...
                <div class="swal2-content">
                    <div id="swal2-content" class="swal2-html-container" style="display: block;">News Release Added
        ...
        <div id="main_dialog_box" class="swal2-container swal2-center swal2-backdrop-show" style="overflow-y: auto;">
            <div aria-labelledby="swal2-title" aria-describedby="swal2-content"
                ...
                <div class="swal2-content">
                    <div id="swal2-content" class="swal2-html-container" style="display: block;">News Release Updated
                        Successfully</div><input class="swal2-input" style="display: none;"><input type="file"
                        class="swal2-file" style="display: none;">
                    <div class="swal2-range" style="display: none;"><input type="range"><output></output></div>
                    <select class="swal2-select" style="display: none;"></select>
        ...
        <?php } ?>
        <form action="<?php echo base_url();?>setting-news-release" onsubmit="return validate();" method="POST">
            <div class="block-content-full">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <button type="button" style="float: right;" class="btn btn-danger" id="delete_news_release"
                            name="delete_news_release"
                            onclick="return deleteNewsRelease('<?php echo $setting_news_release[0]['news_release_settings_id'];?>');">Delete</button>
                        <button type="submit" style="float: right;margin-right:5px;" class="btn btn-info"
                            id="update_news_release" name="update_news_release">Update</button>
                    </div>
                    <?php } else {?>
                        <input type="hidden" id="news_release_token" name="news_release_token" value="<?php echo $_SESSION['news_release_token'] ?>">
                    <button type="submit" style="float:right;" class="btn btn-info" id="save_news_release" name="save_news_release">Save</button>
                </div>
                <?php } ?>
            </div>
            <div class="row">
                <div class="block-content block-content-full">
                    <input type="hidden" name="news_release_settings_id" id="news_release_settings_id"
                        value="<?php if(isset($setting_news_release) && $setting_news_release!='') {echo $setting_news_release[0]['news_release_settings_id'];}else{echo '';}?>">
                    <div class="form-group">
                        <label>News Release Heading</label>
                        <textarea id="news_release_settings_heading" class="summernote"
                            name="news_release_settings_heading"><?php if(isset($setting_news_release) && $setting_news_release!='') {echo $setting_news_release[0]['news_release_settings_heading'];}else{echo '';}?></textarea>
                    </div>
                    <div class="form-group">
                        <label>News Release Description</label>
                        <textarea id="news_release_settings_description" class="summernote"
                            name="news_release_settings_description"><?php if(isset($setting_news_release) && $setting_news_release!='') {echo $setting_news_release[0]['news_release_settings_description'];}else{echo '';}?></textarea>
                    </div>
                </div>
            </div>
...
function validate() {
    var heading = $('#news_release_settings_heading').val();
    var description = $('#news_release_settings_description').val();
...
function close_dialog_delete() {
    ...
    window.location.href = "<?php echo base_url()?>news-release-settings";
}
</script>