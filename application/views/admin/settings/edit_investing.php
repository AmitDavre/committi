...
<div>
        <main id="main-container">
                ...
                <div class="content ">
                        <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-alt">
                                ...
                                <li class="breadcrumb-item">Edit Investing </li>
                            </ol>
                        </nav>
                </div>
            ...
            <div class="content ">
                ...
                <form action="<?php echo base_url();?>investing-setting" method="POST">
                        ...
                        <div class="row">
                            <div class="block-content block-content-full">
                                <div class="form-group">
                                    <textarea id="summernote" class="summernote" name="simplemde"><?php echo $setting_investing;?></textarea>
                                </div>
                            </div>   
                        </div>
