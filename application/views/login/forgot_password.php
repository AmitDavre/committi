                                ...
                                <div class="col-md-8 col-lg-6 col-xl-4">
                                    ...
                                    <div class="block block-themed block-fx-shadow mb-0">
                                        ...
                                        <div class="bg-info block-header">
                                            ...
                                            <h3 style="color: #fff;" class="block-title">Password Reminder</h3>
                                        ...
                                        <div class="block-content">
                                            ...
                                            <div class="p-sm-3 px-lg-4 py-lg-5">
                                                ...
                                                <p>Please provide your account’s email and we will send you your password reset email.</p>
                                                ...
                                                <form action="<?php echo base_url() ?>forgotPassword" method="POST" enctype="multipart/form-data" >
                                                    <div class="form-group py-3">
                                                        <label>Email</label>
                                                        <input type="text" class="form-control form-control-lg form-control-alt" id="email" name="email" placeholder="" style="border-color:#80808038 !important;">
                                                    </div>
                                                     <div class="form-group py-3">
                                                        <label>Date Of Birth</label>
                                                        <input type="date" class="form-control form-control-lg form-control-alt" id="dob" name="dob" placeholder="Date Of Birth" style="border-color:#80808038 !important;">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-6 ">
                                                            ...
                                                            <button type="submit" name="submit" id="submit" class="btn btn-block btn-info">
                                                                ...
                                                                <i style="color: #fff;" class="fa fa-fw fa-envelope mr-1"></i> <span style="color: #fff;"> Send Mail </span>
