...
header.masthead.short_banner .masthead-heading {
    ...
    <body id="page-top">
        ...
        <header class="masthead short_banner">
            <div class="container"> 
                <div class="masthead-heading text-uppercase">Privacy <span>Home / Privacy </span></div>
		...
		<section class="page-section" id="services" style="padding-top:10px !important;">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12 left-mrg">
                         
                        <h4 class="my-3">INTRODUCTION TO PRIVACY POLICY</h4>
                        <p class="text-muted"><?php echo $setting_privacy;?></p>
                    </div>
                </div>
